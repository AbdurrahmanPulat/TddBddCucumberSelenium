...
public class Imdb_Steps {
    ...
    @Given("On the loaded page, clicks the Oscar button under the Award & Events heading.")
    ...
    @Given("Under the Event History heading, the value 1929 is selected.")
    public void under_the_heading_the_value_is_selected() {
        oscarPage = new OscarPage(driver);
        oscarPage.selectYear();
    }

    @Given("The Circus is selected under the Honorary Award")
    public void is_selected_under_the_honorary_award() {
        oscarPage.selectMovie();
    }

    @Given("The loaded page, the director's information, the Writer's information, and the star information of The Circus are saved.")
    ...
    @Given("Click on The Circus that appears among the results.")
    ...
    @Given("The Jazz Singer is selected under the Honorary Award")
    public void theJazzSinger_is_selected_under_the_honorary_award() {
        oscarPage.selectMovie2();
    }

    @Given("The loaded page, the director's information, the Writer's information, and the star information of The Jazz Singer are saved.")
    ...
    @Given("Click on The jazzSinger that appears among the results.")
